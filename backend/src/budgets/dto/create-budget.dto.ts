...
export class CreateBudgetDto {
  ...
  @Type(() => Number)
  @IsNumber({ maxDecimalPlaces: 2 }, { message: 'limitAmount must be a number with up to 2 decimal places' })
  ...
  @IsString()
  @IsIn(['month', 'semester'], { message: 'period must be either "month" or "semester"' })
  period: string;
