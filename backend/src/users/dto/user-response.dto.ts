...
export class AdminUserDto {
  ...
  @ApiPropertyOptional({
    ...
    description: 'When set, the account is suspended; user cannot log in or use the app.',
  })
...
export class AdminUserWithDetailsDto extends AdminUserDto {
  @ApiProperty({ type: UserDetailStatsDto, description: 'Summary counts for this user' })
...
export class UserDetailResponseDto {
  ...
  @ApiProperty({ type: AdminUserDto, description: 'User without stats (from list)' })
  data: AdminUserDto;
}
...
export class UserDetailWithStatsResponseDto {
  ...
  @ApiProperty({ type: AdminUserWithDetailsDto, description: 'User with stats (from GET /:id)' })
